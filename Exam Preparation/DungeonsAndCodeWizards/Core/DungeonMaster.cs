...
namespace DungeonsAndCodeWizards.Core
{
	public class DungeonMaster
    {
        ...
        public string UseItemOn(string[] args)
        {
            ...
            Character giver = GetCharacter(giverCharacterName);
            Character receiver = GetCharacter(reciverCharacterName);
        ...
        public string Attack(string[] args)
        {
            ...
            Character attacker = GetCharacter(giverCharacterName);
			Character receiver = GetCharacter(reciverCharacterName);
        ...
        public string Heal(string[] args)
        {
			...
			Character healer = GetCharacter(giverCharacterName);
			Character receiver = GetCharacter(reciverCharacterName);
        ...
        public string EndTurn(string[] args)
        {
            ...
            foreach (Character character in characters.Where(x => x.IsAlive))
            {
